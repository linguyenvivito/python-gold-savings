...
URL = "https://baotinmanhhai.vn/vi/bang-gia-vang"
...
@router.get("/baotinmanhhai", status_code=status.HTTP_200_OK)
async def scrape_page():
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail=f"Failed to fetch Bao Tin Manh Hai prices: {exc}",
        ) from exc
    finally:
        await page.close()